...
static const resmgr_io_funcs_t text_io_funcs = {_RESMGR_IO_NFUNCS, text_read, text_write, 0, text_stat, 0, text_devctl};
...
static const resmgr_connect_funcs_t text_connect_funcs = {_RESMGR_CONNECT_NFUNCS, text_open};
