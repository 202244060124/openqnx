...
static const resmgr_io_funcs_t zero_io_funcs = {_RESMGR_IO_NFUNCS, zero_read, zero_write, 0, zero_stat, 0, zero_devctl};
...
static const resmgr_connect_funcs_t zero_connect_funcs = {_RESMGR_CONNECT_NFUNCS, zero_open};
