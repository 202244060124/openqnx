...
static const resmgr_io_funcs_t null_io_funcs = {_RESMGR_IO_NFUNCS, null_read, null_write, 0, null_stat, 0, null_devctl};
...
static const resmgr_connect_funcs_t null_connect_funcs = {_RESMGR_CONNECT_NFUNCS, null_open};
