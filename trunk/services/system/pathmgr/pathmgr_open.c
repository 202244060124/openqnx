            ...
            switch (o->hdr.type) {
                case OBJECT_PROC_SYMLINK:
                    ...
                    return complete_open(ctp, oep,
                                         reply_symlink(ctp, msg->connect.eflag, &msg->link_reply, &o->symlink, msg->connect.path, result));
                ...
                case OBJECT_MEM_SHARED:
                    ...
                    if ((msg->connect.subtype != _IO_CONNECT_OPEN) && (msg->connect.subtype != _IO_CONNECT_COMBINE)
