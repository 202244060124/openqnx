...
static const resmgr_io_funcs_t tty_io_funcs = {_RESMGR_IO_NFUNCS, tty_read, tty_write, 0, tty_stat};
...
static const resmgr_connect_funcs_t tty_connect_funcs = {_RESMGR_CONNECT_NFUNCS, tty_open};
