 ...
 */
static __inline__ unsigned arm_mmu_cpuid()
{
    unsigned val;
 ...
 */
static __inline__ unsigned arm_mmu_cache_type()
{
    unsigned val;
 ...
 */
static __inline__ unsigned arm_mmu_getcr()
{
    unsigned val;
 ...
 * Flush data TLBs
 */
static __inline__ void arm_v4_dtlb_flush()
{
 ...
 */
static __inline__ void arm_v4_idtlb_flush()
{
 ...
 */
static __inline__ void arm_v4_dtlb_addr(unsigned addr)
{
 ...
 */
static __inline__ void arm_v4_idtlb_addr(unsigned addr)
{
 ...
 */
static __inline__ unsigned arm_v4_fcse_get()
{
    unsigned pid;
 ...
 */
static __inline__ void arm_v4_fcse_set(unsigned pid)
{
 ...
 */
static __inline__ void arm_v6_dsb()
{
 ...
 * Data Memory Barrier
 */
static __inline__ void arm_v6_dmb()
{
 ...
 * Set TTBR0 register
 */
static __inline__ void arm_v6_ttbr0_set(unsigned ttbr0)
{
 ...
 * Get TTBR0 register
 */
static __inline__ unsigned arm_v6_ttbr0_get()
{
    unsigned ttbr0;
 ...
 * Set current ASID
 */
static __inline__ void arm_v6_asid_set(unsigned asid)
{
 ...
 */
static __inline__ void arm_v6_flush_btc()
{
 ...
 */
static __inline__ void arm_v6_tlb_asid(unsigned asid)
{
 ...
 */
static __inline__ unsigned arm_v6_cpunum()
{
    unsigned cpunum;
