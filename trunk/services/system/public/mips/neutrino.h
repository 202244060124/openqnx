 ...
 */
__inline__ static void __attribute__((__unused__)) (__inline_InterruptDisable)(void)
{
 ...
 */
__inline__ static void __attribute__((__unused__)) (__inline_InterruptEnable)(void)
{
    unsigned t1, t2;
    /*
 ...
 */
__inline__ static void __attribute__((__unused__)) (__inline_InterruptLock)(struct intrspin* __spin)
{
    unsigned __result;
 ...
 */
__inline__ static void __attribute__((__unused__)) (__inline_InterruptUnlock)(struct intrspin* __spin)
{
 ...
 */
__inline__ static unsigned(__inline_InterruptStatus)(void)
{
    _Uint32t __sreg;
    __asm__ __volatile__(".set noreorder        ;"
                         "mfc0     %0, $12     ;"
