...
#define RMSK_SET(cpu, p)          ((p)[(cpu) / __INT_BITS__] |= (1 << ((cpu) % __INT_BITS__)))

#define RMSK_CLR(cpu, p)          ((p)[(cpu) / __INT_BITS__] &= ~(1 << ((cpu) % __INT_BITS__)))

#define RMSK_ISSET(cpu, p)        ((p)[(cpu) / __INT_BITS__] & (1 << ((cpu) % __INT_BITS__)))
...
extern int ChannelCreateExt(unsigned __flags, mode_t __mode, size_t __bufsize, unsigned __maxnumbuf, const struct sigevent* __ev,
                            struct _cred_info* __cred);
...
extern int ChannelConnectAttr(unsigned __id, union _channel_connect_attr* __old_attr, union _channel_connect_attr* __new_attr,
                              unsigned __flags);
...
extern int InterruptAttach(int __intr, const struct sigevent* (*__handler)(void* __area, int __id), const void* __area, int __size,
                           unsigned __flags);
extern int InterruptAttach_r(int __intr, const struct sigevent* (*__handler)(void* __area, int __id), const void* __area, int __size,
                             unsigned __flags);
...
extern int TimerTimeout_r(clockid_t __id, int __flags, const struct sigevent* __notify, const _Uint64t* __ntime, _Uint64t* __otime);
