...
typedef struct {
    ...
    _Int16t reserved1;
    _Uint32t* scheduling_policy_flagsp; /* points an or-ing of SCHED_APS_SCHED_SCHEDPOL_*i, described under "Scheduling Policy Flags" below.
                                           Set to NULL for no change */
    _Uint32t* bankruptcy_policyp; /*points to an or-ing of SCHED_APS_BNKR_* flags, described under "handling bankruptcy" below. Set to NULL
                                     for no change*/
    _Int32t reserved2;
    _Int64t reserved3;
} sched_aps_parms;
...
#define SCHED_APS_PSTATS_IS_BANKRUPT_NOW                                                             \
    0x00000001                                   /* critical time used > critical budget at the time \
...
#define SCHED_APS_SEC_FLEXIBLE                                                                                              \
    (SCHED_APS_SEC_BASIC | SCHED_APS_SEC_NONZERO_BUDGETS | SCHED_APS_SEC_ROOT_MAKES_PARTITIONS | SCHED_APS_SEC_PARENT_JOINS \
     | SCHED_APS_SEC_PARENT_MODIFIES)

#define SCHED_APS_SEC_RECOMMENDED \
    (SCHED_APS_SEC_FLEXIBLE | SCHED_APS_SEC_SYS_MAKES_PARTITIONS | SCHED_APS_SEC_SYS_JOINS | SCHED_APS_SEC_JOIN_SELF_ONLY)
