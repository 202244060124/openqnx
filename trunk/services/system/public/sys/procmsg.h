...
enum { _PROC_EVENT_NOTIFY, _PROC_EVENT_TRIGGER, _PROC_EVENT_NOTIFY_ADD, _PROC_EVENT_NOTIFY_DEL };

enum { _PROC_UMASK_SET, _PROC_UMASK_GET };

enum { _PROC_RESOURCE_USAGE, _PROC_RESOURCE_GETLIMIT, _PROC_RESOURCE_SETLIMIT };
...
#define SPAWN_REMOTE_REMOTEBUF_SIZE \
    sizeof(struct _proc_spawn_fd_info) * SPAWN_REMOTE_FDARRAY_SIZE + PATH_MAX * 2 + sizeof(proc_spawn_remote_t)
...
enum { _PROC_SPAWN_DIR_ALL, _PROC_SPAWN_DIR_ROOT, _PROC_SPAWN_DIR_CWD };
