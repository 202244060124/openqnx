 ...
 */
#if !defined(SYSPAGE_TARGET_ALL) && !defined(SYSPAGE_TARGET_X86) && !defined(SYSPAGE_TARGET_PPC) && !defined(SYSPAGE_TARGET_MIPS) \
    && !defined(SYSPAGE_TARGET_ARM) && !defined(SYSPAGE_TARGET_SH)
#if defined(__X86__)
 ...
 *	System page types
 */
enum { SYSPAGE_X86, SYSPAGE_PPC, SYSPAGE_MIPS, SYSPAGE_SPARE, SYSPAGE_ARM, SYSPAGE_SH };
...
typedef enum { DEBUG_WATCHDOG_STOP = 0, DEBUG_WATCHDOG_CONTINUE, DEBUG_WATCHDOG_FEED } debug_watchdog_cmd;
...
enum { MEMTYPE_NONE, MEMTYPE_RAM, MEMTYPE_IMAGEFSYS, MEMTYPE_BOOTRAM, MEMTYPE_RESERVED, MEMTYPE_IOMEM, MEMTYPE_FLASHFSYS };
...
struct asinfo_entry {
    ...
    _Uint16t attr;
    _Uint16t priority;
    int (*alloc_checker)(struct syspage_entry* __sp, _Uint64t* __base, _Uint64t* __len, _Sizet __size, _Sizet __align);
    _Uint32t spare;
};
...
#define _SYSPAGE_ENTRY_SIZE(__base, __field) ((__base)->__field.entry_size)

#define SYSPAGE_ENTRY_SIZE(__field)          _SYSPAGE_ENTRY_SIZE(_syspage_ptr, __field)

#define _SYSPAGE_ENTRY(__base, __field)      ((struct __field##_entry*)(void*)((char*)(__base) + (__base)->__field.entry_off))
