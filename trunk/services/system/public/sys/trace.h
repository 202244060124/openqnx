...
#define _TRACE_HEADER_KEYWORDS()                                                                                                     \
    _TRACE_MK_HK(HEADER_BEGIN), _TRACE_MK_HK(FILE_NAME), _TRACE_MK_HK(DATE), _TRACE_MK_HK(VER_MAJOR), _TRACE_MK_HK(VER_MINOR),       \
        _TRACE_MK_HK(LITTLE_ENDIAN), _TRACE_MK_HK(BIG_ENDIAN), _TRACE_MK_HK(MIDDLE_ENDIAN), _TRACE_MK_HK(ENCODING),                  \
        _TRACE_MK_HK(BOOT_DATE), _TRACE_MK_HK(CYCLES_PER_SEC), _TRACE_MK_HK(CPU_NUM), _TRACE_MK_HK(SYSNAME), _TRACE_MK_HK(NODENAME), \
        _TRACE_MK_HK(SYS_RELEASE), _TRACE_MK_HK(SYS_VERSION), _TRACE_MK_HK(MACHINE), _TRACE_MK_HK(SYSPAGE_LEN), _TRACE_MK_HK(HEADER_END)
...
#ifdef __WATCOMC__
#pragma aux _trace_getpc = "  call foo" \
