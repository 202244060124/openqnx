...
#define PART_TYPE(_id_)                                      \
    ((((_id_)&parttype_MASK) == parttype_MEM) ? parttype_MEM \
 ...
 */
#define PART_PLIST_T_SIZE(n) ((sizeof(part_plist_t) - sizeof(pid_t)) + ((n) * sizeof(pid_t)))
 ...
 *         implementation is coded to ensure the proper result even for 'n' == 0
 */
#define PART_LIST_T_SIZE(n) ((sizeof(part_list_t) - sizeof(partlist_info_t)) + ((n) * sizeof(partlist_info_t)))
