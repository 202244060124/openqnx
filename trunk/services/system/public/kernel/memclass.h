...
#define MEMCLASS_DEFAULT_ATTR                                                                                              \
    {                                                                                                                      \
        STRUCT_FLD(size) 0, STRUCT_FLD(limits){STRUCT_FLD(alloc){STRUCT_FLD(size){STRUCT_FLD(min) 0, STRUCT_FLD(max) 0}}}, \
    }
...
#define PROC_MEMCLASS_SIZEINFO_T_SIZE(n) \
    ((sizeof(proc_memclass_sizeinfo_t) - sizeof(struct per_class_sizeinfo_s)) + ((n) * sizeof(struct per_class_sizeinfo_s)))
