...
#define MEMPART_DFLT_POLICY_INITIALIZER                                                         \
    {                                                                                           \
        STRUCT_FLD(terminal)                                                                    \
        bool_t_FALSE, STRUCT_FLD(config_lock) bool_t_FALSE, STRUCT_FLD(permanent) bool_t_FALSE, \
 ...
 */
#define MEMPART_OLIST_T_SIZE(n) ((sizeof(mempart_olist_t) - sizeof(struct obj_info_s)) + ((n) * sizeof(struct obj_info_s)))
