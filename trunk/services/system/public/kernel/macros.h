...
#define _NTO_TF_PUBLIC_MASK                                                                                                     \
    (_NTO_TF_INTR_PENDING | _NTO_TF_DETACHED | _NTO_TF_THREADS_HOLD | _NTO_TF_UNBLOCK_REQ | _NTO_TF_ALIGN_FAULT | _NTO_TF_SSTEP \
     | _NTO_TF_ALLOCED_STACK | _NTO_TF_NOMULTISIG | _NTO_TF_FROZEN | _NTO_TF_IOPRIV)
...
#define LINK4_INIT(_queue)    ((_queue).count = ((unsigned int)((_queue).head = (_queue).tail = NULL)))
