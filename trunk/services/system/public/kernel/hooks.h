...
#define MM_FUNCS(extra)                                                                                                                 \
    ...
    MMF(int, map_xfer, (PROCESS * actprp, PROCESS * prp, IOV * *piov, int* pparts, int* poff, IOV* niov, int* pnparts, unsigned flags), \
        extra)                                                                                                                          \
    MMF(int, mcreate, (PROCESS * prp), extra)                                                                                           \
    MMF(void, mdestroy, (PROCESS * prp), extra)                                                                                         \
    MMF(int, dup, (PROCESS * pprp, PROCESS * prp), extra)                                                                               \
    MMF(int, mmap,                                                                                                                      \
        (PROCESS * prp, uintptr_t addr, size_t len, int prot, int flags, OBJECT* obp, uint64_t off, unsigned align, unsigned prealloc,  \
         int fd, void** vaddr, size_t* size, MPART_ID mpid),                                                                            \
        extra)                                                                                                                          \
    ...
    MMF(size_t, mapinfo,                                                                                                                \
        (PROCESS * prp, uintptr_t vaddr, struct _procfs_map_info * info, struct _procfs_debug_info * debug, size_t, OBJECT**, int* fd,  \
         size_t* contigp),                                                                                                              \
        extra)                                                                                                                          \
