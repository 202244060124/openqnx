...
#define SH_IS_P1(x)                 (((x) >= SH_P1BASE) && ((x) <= (SH_P1BASE + SH_P1SIZE - 1)))

#define SH_PHYS_TO_P2(x)            (SH_P2BASE | (_Uint32t)(x))
#define SH_P2_TO_PHYS(x)            ((_Uint32t)(x) & ~SH_P2BASE)
#define SH_IS_P2(x)                 (((x) >= SH_P2BASE) && ((x) <= (SH_P2BASE + SH_P2SIZE - 1)))

#define SH_IS_P3(x)                 (((x) >= SH_P3BASE) && ((x) <= (SH_P3BASE + SH_P3SIZE - 1)))

#define SH_IS_P4(x)                 (((x) >= SH_P4BASE) && ((x) <= (SH_P4BASE + SH_P4SIZE - 1)))
#define SH_P4_TO_PHYS(x)            ((_Uint32t)(x) & ~SH_P4BASE)
#define SH_PHYS_TO_P4(x)            ((_Uint32t)(x) | SH_P4BASE)

#define SH_IS_P0(x)                 (((x) >= SH_P0BASE) && ((x) < (SH_P0BASE + SH_P0SIZE)))

#define SH_IS_U0(x)                 (((x) >= SH_U0BASE) && ((x) < (SH_U0BASE + SH_U0SIZE)))
