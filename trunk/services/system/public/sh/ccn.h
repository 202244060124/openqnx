...
#define SH_PTE_PGSIZE(ptel)      ((ptel & SH_CCN_PTEL_SZ1) ? ((ptel & SH_CCN_PTEL_SZ0) ? MEG(1) : KILO(64)) : KILO(4))

// NOTE: we don't support 1K pages (sz0 & sz1 both 0)
#define SH_PTE_PGSIZE_MASK(ptel) ((ptel & SH_CCN_PTEL_SZ1) ? ((ptel & SH_CCN_PTEL_SZ0) ? 0xfff00000 : 0xffff0000) : 0xfffff000)
