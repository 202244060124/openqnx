...
static __inline__ void __attribute__((__unused__)) (__inline_InterruptLock)(struct intrspin* __spin)
{
...
static __inline__ void __attribute__((__unused__)) (__inline_InterruptUnlock)(struct intrspin* __spin)
{
    /*
...
static __inline__ void __attribute__((__unused__)) (__inline_InterruptEnable)(void)
{
    unsigned __tmp;
...
static __inline__ void __attribute__((__unused__)) (__inline_InterruptDisable)(void)
{
    __asm__ __volatile__("stc    sr,r0;"
                         "or        #0xf0,r0;"
                         "ldc    r0,sr;"
...
static __inline__ void __attribute__((__unused__)) (__inline_InterruptLock)(struct intrspin* __spin)
{
    ...
    if (__cpu_flags & __SH_CPU_FLAG_SMP) {
        ...
        __asm__ __volatile__("0:    mov        %1, r1;"
                             "    mov.l    @r1, r0;"
                             "    tst        r0, r0;"
                             "    bf        0b;"
                             "    .word    0x0163;"   /* movli.l @r1, r0         */
...
static __inline__ unsigned(__inline_InterruptStatus)(void)
{
    unsigned __val;
 ...
 */
static __inline__ void __attribute__((__unused__)) (__inline_DebugBreak)(void)
{
 ...
 * the debugger.
 */
static __inline__ void __attribute__((__unused__)) (__inline_DebugKDBreak)(void)
{
 ...
 * which is defined in ker/sh/kercpu.h
 */
static __inline__ void __attribute__((__unused__)) (__inline_DebugKDOutput)(const char* __text, _CSTD size_t __len)
{
...
static __inline__ _Uint64t __attribute__((__unused__)) ClockCycles(void)
{
    unsigned __lo, __tmp;
