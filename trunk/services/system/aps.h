 ...
 */
#define SCHEDPART_VALIDATE_ID(spid)             (SCHEDPART_INSTALLED() ? schedpart_validate_id((spid)) : EINVAL)
 ...
 *
 */
#define SCHEDPART_VALIDATE_ASSOCIATION(spid, c) (SCHEDPART_INSTALLED() ? schedpart_fnctbl->validate_association((spid), (c)) : EINVAL)
 ...
 */
#define SCHEDPART_INIT(i_spid, i) \
    if (schedpart_init != NULL)   \
    schedpart_init((i_spid), (i))
