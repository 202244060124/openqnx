...
static int set_rlimit_resource(rlim_t cur, rlim_t max, uint32_t* rlim_soft, uint32_t* rlim_hard, resmgr_context_t* ctp)
{
...
int procmgr_msg_resource(resmgr_context_t* ctp, void* vmsg)
{
    ...
    switch (msg->hdr.subtype) {
        ...
        case _PROC_RESOURCE_SETLIMIT:
            ...
            ret = set_rlimit_resource(cur, max, &prp->rlimit_vals_soft[msg->setlimit.i.entry[0].resource],
