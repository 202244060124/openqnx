...
const long sysmgr_conf_table[] = {_CONF_CALL_FCN, (intptr_t)sysmgr_conf_get, _CONF_VALUE_NUM | _SC_ARG_MAX, ARG_MAX,
                                  _CONF_VALUE_MIN | _SC_NGROUPS_MAX, NGROUPS_MAX,
                                  //    _CONF_VALUE_NUM |            _SC_JOB_CONTROL,            1,
                                  _CONF_VALUE_NUM | _SC_VERSION, _POSIX_VERSION, _CONF_VALUE_MIN | _CONF_INDIRECT | _SC_PAGESIZE,
                                  (intptr_t)&memmgr.pagesize, _CONF_STR | _CONF_CALL_FCN, (intptr_t)sysmgr_strconf, _CONF_LINK,
                                  (intptr_t)kernel_conf_table};
