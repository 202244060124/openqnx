...
int map_create(struct map_set*, struct map_set*, struct mm_map_head*, uintptr_t va, uintptr_t size, uintptr_t mask, unsigned flags);
uintptr_t map_find_va(struct mm_map_head*, uintptr_t va, uintptr_t size, uintptr_t mask, unsigned flags);
...
extern uintptr_t (*vaddr_search_adjust_hook)(uintptr_t vaddr, ADDRESS* adp, unsigned flags, uintptr_t size);
...
#define SHM_LAZY(o) (((o)->hdr.type == OBJECT_MEM_SHARED) && ((o)->mem.mm.flags & SHMCTL_LAZY))
