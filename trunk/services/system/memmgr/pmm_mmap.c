...
int pmm_mmap(PROCESS* prp, uintptr_t addr, size_t len, int prot, int flags, OBJECT* obp, uint64_t boff, unsigned align, unsigned preload,
             int fd, void** vaddr, size_t* size, part_id_t mpart_id)
{
    unsigned off = boff;
