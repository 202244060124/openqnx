...
#define ISNOT_PRESENT_READABLE(pte)  (((pte) & (SH_CCN_PTEL_PR(2) | SH_CCN_PTEL_V)) != (SH_CCN_PTEL_PR(2) | SH_CCN_PTEL_V))
#define ISNOT_PRESENT_WRITEABLE(pte) (((pte) & (SH_CCN_PTEL_PR(1) | SH_CCN_PTEL_V)) != (SH_CCN_PTEL_PR(1) | SH_CCN_PTEL_V))

#define NUM_TLB_RESERVED             2

static inline void __attribute__((__unused__)) _p2_out32(unsigned __dst, unsigned __new)
{
    unsigned amask = 0xa0000000;
    __asm__ __volatile__("	mova	1f,r0;"
                         "	bra		2f;"
                         "	nop;"
                         ".align 2;"
                         "1:;"
...
static inline unsigned __attribute__((__unused__)) _p2_in32(unsigned __src)
{
