...
#define PTE_PGSIZE(ptep)                   (0x400 << (((ptep)->flags >> (PPCBKE_PTE_PGSZ_SHIFT - 1)) & (PPCBKE_PTE_PGSZ_MASK >> (PPCBKE_PTE_PGSZ_SHIFT - 1))))
#define PTE_PADDR(ptep)                    (((ptep)->paddr & ~0xfff) | ((paddr_t)((ptep)->paddr & 0xfff) << 32))
