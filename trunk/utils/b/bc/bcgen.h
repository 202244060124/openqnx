...
#define do_define(_c, _lbl) \
    ((_c)->label[_lbl] = _c->cur_offs, (_c)->lbl_flags &= ~(_LABEL_MASK << (_lbl * 2)), (_c)->lbl_flags |= (_LABEL_DEFINED << (_lbl * 2)))

#define do_reference(_c, _lbl) ((_c)->lbl_flags &= ~(_LABEL_MASK << (_lbl * 2)), (_c)->lbl_flags |= (_LABEL_USED << (_lbl * 2)))
